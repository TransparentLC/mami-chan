...
export interface IMediaFileReader<T = IMediaFileReaderInstance> {
    canReadFile(file: any): boolean;
    new (file: any): T;
}

export interface IMediaFileReaderInstance {
    getSize(): number;
...
export default class MediaFileReader implements IMediaFileReaderInstance {
    _isInitialized: boolean;
    _size: number;
